...
enum JournalMeta_JOURNAL_STATUS {
  JournalMeta_JOURNAL_STATUS_CREATED = 0,
  JournalMeta_JOURNAL_STATUS_OPENED = 1,
  JournalMeta_JOURNAL_STATUS_SEALED = 2,
  JournalMeta_JOURNAL_STATUS_JournalMeta_JOURNAL_STATUS_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  JournalMeta_JOURNAL_STATUS_JournalMeta_JOURNAL_STATUS_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool JournalMeta_JOURNAL_STATUS_IsValid(int value);
const JournalMeta_JOURNAL_STATUS JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_MIN = JournalMeta_JOURNAL_STATUS_CREATED;
const JournalMeta_JOURNAL_STATUS JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_MAX = JournalMeta_JOURNAL_STATUS_SEALED;
const int JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_ARRAYSIZE = JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_MAX + 1;

const ::google::protobuf::EnumDescriptor* JournalMeta_JOURNAL_STATUS_descriptor();
inline const ::std::string& JournalMeta_JOURNAL_STATUS_Name(JournalMeta_JOURNAL_STATUS value) {
  return ::google::protobuf::internal::NameOfEnum(
    JournalMeta_JOURNAL_STATUS_descriptor(), value);
}
inline bool JournalMeta_JOURNAL_STATUS_Parse(
    const ::std::string& name, JournalMeta_JOURNAL_STATUS* value) {
  return ::google::protobuf::internal::ParseNamedEnum<JournalMeta_JOURNAL_STATUS>(
    JournalMeta_JOURNAL_STATUS_descriptor(), name, value);
}
// ===================================================================
...
class JournalMeta : public ::google::protobuf::Message {
 public:
  ...
  typedef JournalMeta_JOURNAL_STATUS JOURNAL_STATUS;
  static const JOURNAL_STATUS CREATED =
    JournalMeta_JOURNAL_STATUS_CREATED;
  static const JOURNAL_STATUS OPENED =
    JournalMeta_JOURNAL_STATUS_OPENED;
  static const JOURNAL_STATUS SEALED =
    JournalMeta_JOURNAL_STATUS_SEALED;
  static inline bool JOURNAL_STATUS_IsValid(int value) {
    return JournalMeta_JOURNAL_STATUS_IsValid(value);
  }
  static const JOURNAL_STATUS JOURNAL_STATUS_MIN =
    JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_MIN;
  static const JOURNAL_STATUS JOURNAL_STATUS_MAX =
    JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_MAX;
  static const int JOURNAL_STATUS_ARRAYSIZE =
    JournalMeta_JOURNAL_STATUS_JOURNAL_STATUS_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  JOURNAL_STATUS_descriptor() {
    return JournalMeta_JOURNAL_STATUS_descriptor();
  }
  static inline const ::std::string& JOURNAL_STATUS_Name(JOURNAL_STATUS value) {
    return JournalMeta_JOURNAL_STATUS_Name(value);
  }
  static inline bool JOURNAL_STATUS_Parse(const ::std::string& name,
      JOURNAL_STATUS* value) {
    return JournalMeta_JOURNAL_STATUS_Parse(name, value);
  }
  ...
  // optional .huawei.proto.JournalMeta.JOURNAL_STATUS status = 2;
  void clear_status();
  static const int kStatusFieldNumber = 2;
  ::huawei::proto::JournalMeta_JOURNAL_STATUS status() const;
  void set_status(::huawei::proto::JournalMeta_JOURNAL_STATUS value);
...
inline ::huawei::proto::JournalMeta_JOURNAL_STATUS JournalMeta::status() const {
  // @@protoc_insertion_point(field_get:huawei.proto.JournalMeta.status)
  return static_cast< ::huawei::proto::JournalMeta_JOURNAL_STATUS >(status_);
}
inline void JournalMeta::set_status(::huawei::proto::JournalMeta_JOURNAL_STATUS value) {
...
template <> struct is_proto_enum< ::huawei::proto::JournalMeta_JOURNAL_STATUS> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::huawei::proto::JournalMeta_JOURNAL_STATUS>() {
  return ::huawei::proto::JournalMeta_JOURNAL_STATUS_descriptor();
}
