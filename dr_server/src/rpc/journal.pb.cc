...
const ::google::protobuf::EnumDescriptor* JournalMeta_JOURNAL_STATUS_descriptor_ = NULL;
...
void protobuf_AssignDesc_journal_2eproto() {
  ...
  JournalMeta_JOURNAL_STATUS_descriptor_ = JournalMeta_descriptor_->enum_type(0);
}
...
void protobuf_AddDesc_journal_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\rjournal.proto\022\014huawei.proto\"\214\001\n\013Journa"
    "lMeta\022\014\n\004path\030\001 \001(\t\0228\n\006status\030\002 \001(\0162(.hu"
    "awei.proto.JournalMeta.JOURNAL_STATUS\"5\n"
    "\016JOURNAL_STATUS\022\013\n\007CREATED\020\000\022\n\n\006OPENED\020\001"
    "\022\n\n\006SEALED\020\002B\006\242\002\003DRSb\006proto3", 188);
...
const ::google::protobuf::EnumDescriptor* JournalMeta_JOURNAL_STATUS_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return JournalMeta_JOURNAL_STATUS_descriptor_;
}
...
const JournalMeta_JOURNAL_STATUS JournalMeta::CREATED;
const JournalMeta_JOURNAL_STATUS JournalMeta::OPENED;
const JournalMeta_JOURNAL_STATUS JournalMeta::SEALED;
const JournalMeta_JOURNAL_STATUS JournalMeta::JOURNAL_STATUS_MIN;
const JournalMeta_JOURNAL_STATUS JournalMeta::JOURNAL_STATUS_MAX;
const int JournalMeta::JOURNAL_STATUS_ARRAYSIZE;
        ...
        if (tag == 16) {
         parse_status:
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_status(static_cast< ::huawei::proto::JournalMeta_JOURNAL_STATUS >(value));
        } else {
          goto handle_unusual;
        }
...
void JournalMeta::clear_status() {
 ...
 ::huawei::proto::JournalMeta_JOURNAL_STATUS JournalMeta::status() const {
 ...
 void JournalMeta::set_status(::huawei::proto::JournalMeta_JOURNAL_STATUS value) {
