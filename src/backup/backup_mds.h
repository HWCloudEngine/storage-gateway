...
public:
    ...
    StatusCode query_backup(const QueryBackupInReq* req, QueryBackupInAck* ack);
...
private:
    ...
    /*give a incr backup, get the full backup of the incr backup*/
    string get_incr_bakcup_base(const string& cur_backup);
...
private:
    ...
    /*(todo may be not)backup object and backup referece map */
