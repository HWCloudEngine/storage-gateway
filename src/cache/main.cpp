...
int main(int argc, char** argv)
{
    ...
    shared_ptr<ReplayEntry> le1(new ReplayEntry((char*)log_1, (uint32_t)lsize, (uint64_t)log_seq));
    ...
    shared_ptr<ReplayEntry> le2(new ReplayEntry((char*)log_2, (uint32_t)lsize, (uint64_t)log_seq));
    ...
    shared_ptr<ReplayEntry> le3(new ReplayEntry((char*)log_3, (uint32_t)lsize, (uint64_t)log_seq));
    ...
    shared_ptr<ReplayEntry> le4(new ReplayEntry((char*)log_4, (uint32_t)lsize, (uint64_t)log_seq));
