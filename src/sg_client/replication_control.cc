...
************************************************/
#include <string>
#include "replication_control.h"
#include "common/config_parser.h"
#include "log/log.h"
using std::string;
ReplicationCtrl::ReplicationCtrl(ControlService* snap_ctrl):
...
ReplicationCtrl::~ReplicationCtrl(){
}

Status ReplicationCtrl::CreateReplication(ServerContext* context,
...
Status ReplicationCtrl::EnableReplication(ServerContext* context,
...
Status ReplicationCtrl::DisableReplication(ServerContext* context,
...
Status ReplicationCtrl::FailoverReplication(ServerContext* context,
...
Status ReplicationCtrl::ReverseReplication(ServerContext* context,
...
Status ReplicationCtrl::DeleteReplication(ServerContext* context,
