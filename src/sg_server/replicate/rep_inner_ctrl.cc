...
Status RepInnerCtrl::CreateReplication(ServerContext* context,
    ...
    LOG_INFO << "create replication:\n"
        ...
        << "role:" << role << "\n"
        << "peer volume count:" << request->peer_volume_size() << "\n";
    VolumeMeta meta;
...
//    }
    ...
    for(string vol:request->peer_volume()){
        meta.mutable_info()->add_peer_volume(vol);
...
Status RepInnerCtrl::ReportReplicationCP(ServerContext* context,
