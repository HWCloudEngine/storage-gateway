...
void DbUtil::split_cow_block_map_key(const string& raw_key, snapid_t& snap_id,
                                     block_t& block_id) {
    string prefix;
    string key;
...
void DbUtil::split_cow_object_map_key(const string& raw_key, string& obj_name) {
    string prefix;
