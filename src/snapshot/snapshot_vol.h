#ifndef SNAPSHOT_VOL_H_
#define SNAPSHOT_VOL_H_
...
/*each volume has a SnapshotVol manage snapshot, replication and backup metadata*/
class SnapshotVol
{

public:
    SnapshotVol(const string vol_name);
    ~SnapshotVol();
